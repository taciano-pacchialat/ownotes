...
import 'package:ownotes/utilities/dialogs/password_reset_email_sent_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            ...
            await showErrorDialog(
              context,
              'We could not process your request. Make sure you are a registered user, or if not, register a user now by going back one step',
            );
          }
        }
      },
